...
struct TodayView: View {
        ...
        Button {
            ...
            .overlay(alignment: .bottomTrailing) {
                Image(systemName: "checkmark")
                    ...
                    .foregroundStyle(vm.containDoseList(medicine) ? Color.Primary : Color.GrayAF.opacity(0.2))
                    .padding(.trailing, 32)
            }
    ...
    private var sleepCycleView: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            .labelsHidden()
            .hView(.leading)
            .onChange(of: vm.todayRecord.sleepCycle) { value in
                vm.updateSleepCycle(value)
            }
        }
    }
                ...
                ForEach(Status.allCases, id: \.hashValue) { status in
                    Button {
                        ...
                        Text(status.rawValue)
                            ...
                            .foregroundStyle(vm.containStatus(status) ? Color.DarkBlue :Color.TextBlack)
