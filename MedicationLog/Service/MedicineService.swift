...
class MedicineService {
    ...
    @Published var medicineList: [Medicine] = [
        Medicine(name: "Levodopa", capacity: "200", capacityUnit: .mg, frequency: [Frequency(day: [.Mon, .Wed, .Fri, .Thu], type: .NotSpecified, count: 1)]),
        Medicine(name: "Pramipexole", capacity: "0.75", capacityUnit: .mg, frequency: [Frequency(day: [.Mon, .Tue, .Wed, .Thu], type: .CustomTime(.BeforeBedtime), count: 1), Frequency(day: [.Sat, .Sun], type: .NotSpecified, count: 1)])
    ]
